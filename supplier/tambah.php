...
<head>
  ...
  <title><?= $_SESSION['app_name'] ?> - Tambah Data Supplier</title>
		...
		<!-- Main Content -->
			<div id="content">
				...
				<div class="container-fluid">
					<!-- Page Heading -->
					<div class="clearfix">
						<h1 class="h3 mb-4 text-gray-800 float-left">Tambah Data Supplier</h1>
									...
									<form action="proses_tambah.php" method="POST">
										<div class="form-group">
											...
											<div class="input-group">
												...
												<input type="number" id="kode_supplier" class="form-control" placeholder="Masukan Kode Supplier" name="kode_supplier" autocomplete="off" required="required">
											</div>
										</div>
										<div class="form-group">
											...
											<div class="input-group">
												...
												<input type="text" id="nama_supplier" class="form-control" placeholder="Masukan Nama Supplier" name="nama_supplier" autocomplete="off" required="required">
											</div>
										</div>
										<div class="form-group">
											...
											<div class="input-group">
												...
												<textarea name="alamat_supplier" id="alamat_supplier" class="form-control" placeholder="Masukan Alamat Supplier" required="required" autocomplete="off"></textarea>
											</div>
										</div>
										<div class="form-group">
