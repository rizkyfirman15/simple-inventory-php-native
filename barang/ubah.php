...
<head>
  ...
  <title><?= $_SESSION['app_name'] ?> - Ubah Data Barang</title>
		...
		<!-- Main Content -->
			<div id="content">
				...
				<div class="container-fluid">
					<!-- Page Heading -->
					<div class="clearfix">
						<h1 class="h3 mb-4 text-gray-800 float-left">Ubah Data Barang</h1>
					...
					<div class="row">
						<div class="col-md-8">
							<div class="card">
								...
								<div class="card-body">
									<form action="proses_ubah.php?id=<?php echo $barang['id'] ?>" method="POST">
										<div class="form-group">
											...
											<div class="input-group">
												...
												<input type="text" id="kode_barang" class="form-control" placeholder="Masukan kode Barang" name="kode_barang" autocomplete="off" required="required" value="<?php echo $barang['kode_barang'] ?>">
											</div>
										</div>
										<div class="form-group">
											...
											<div class="input-group">
												...
												<input type="text" id="nama_barang" class="form-control" placeholder="Masukan Nama Barang" name="nama_barang" autocomplete="off" required="required" value="<?php echo $barang['nama_barang'] ?>">
											</div>
										</div>
										<div class="form-group">
											...
											<div class="input-group">
												...
												<input type="number" id="stok_barang" class="form-control" placeholder="Masukan stok Barang" name="stok_barang" autocomplete="off" required="required" value="<?php echo $barang['stok_barang'] ?>">
											</div>
										</div>
										<div class="form-group">
											...
											<div class="input-group">
												...
												<select name="jenis_barang" id="jenis_barang" class="form-control">
													...
													<option value="Kendaraan" <?php echo $barang['jenis_barang'] == 'Kendaraan' ? 'selected' : '' ?>>Kendaraan</option>
													<option value="Furniture" <?php echo $barang['jenis_barang'] == 'Furniture' ? 'selected' : '' ?>>Furniture</option>
												</select>
											</div>
										</div>
										<div class="form-group">
