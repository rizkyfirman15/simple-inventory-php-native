...
<head>
  ...
  <title><?= $_SESSION['app_name'] ?> - Tambah Data Barang</title>
		...
		<!-- Main Content -->
			<div id="content">
				...
				<div class="container-fluid">
					<!-- Page Heading -->
					<div class="clearfix">
						<h1 class="h3 mb-4 text-gray-800 float-left">Tambah Data Barang</h1>
								...
								<div class="card-body">
									...
									<div class="form-group">
											...
											<div class="input-group">
												...
												<input type="text" id="kode_barang" class="form-control" placeholder="Masukan kode Barang" name="kode_barang" autocomplete="off" required="required">
											</div>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<div class="input-group">
												...
												<input type="number" id="stok_barang" class="form-control" placeholder="Masukan Stok Barang" name="stok_barang" autocomplete="off" required="required">
											</div>
										</div>
										<div class="form-group">
