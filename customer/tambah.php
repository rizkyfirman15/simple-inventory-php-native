...
<head>
  ...
  <title><?= $_SESSION['app_name'] ?> - Tambah Data Customer</title>
		...
		<!-- Main Content -->
			<div id="content">
				...
				<div class="container-fluid">
					<!-- Page Heading -->
					<div class="clearfix">
						<h1 class="h3 mb-4 text-gray-800 float-left">Tambah Data Customer</h1>
									...
									<form action="proses_tambah.php" method="POST">
										<div class="form-group">
											...
											<div class="input-group">
												...
												<input type="text" id="nama_customer" class="form-control" placeholder="Masukan Nama Customer" name="nama_customer" autocomplete="off" required="required">
											</div>
										</div>
										<div class="form-group">
											...
											<div class="input-group">
												...
												<input type="text" id="alamat_customer" class="form-control" placeholder="Masukan Alamat Customer" name="alamat_customer" autocomplete="off" required="required">
											</div>
										</div>
										<div class="form-group">
